...
var RosterOrderView = Backbone.View.extend({

    name: 'roster_order',
    id: 'cmtyx_rosterOrder',
    ...
    getPrefillAddress: function() {
        var number, street , street2, city, state,zip;
        ...
        /* if address was specified in URL then use that */
        /* TODO: move this parsing to php */
        /*
        ...
        */
        return {
          deliveryStreet: (typeof street === 'undefined') ? '' : street,
          deliveryCity: (typeof city === 'undefined') ? '' : city,
          deliveryNumber: (typeof number === 'undefined' ) ? '' : number,
          deliveryStreet2: (typeof street2 === 'undefined' ) ? '' : street2
        };
    },
