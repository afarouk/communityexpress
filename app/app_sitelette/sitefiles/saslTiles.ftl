									...
									<div class="tile">
										<div class="header" style="background-color:${tile.tileColor};">
											...
											<#if tile.promoType.enumText=="UNDEFINED" > <img
												src="/sitefiles/images/promoType/OTHER.png" alt="promoType"
												class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="ACTIVITY" > <img
												src="/sitefiles/images/promoType/ACTIVITY.png"
												alt="promoType" class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="DINING_DEAL" > <img
												src="/sitefiles/images/promoType/DINING_DEAL.png"
												alt="promoType" class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="DISCOUNT" > <img
												src="/sitefiles/images/promoType/DISCOUNT.png"
												alt="promoType" class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="ENTERTAINMENT" > <img
												src="/sitefiles/images/promoType/ENTERTAINMENT.png"
												alt="promoType" class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="HAPPYHOUR" > <img
												src="/sitefiles/images/promoType/HAPPYHOUR.png"
												alt="promoType" class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="OTHER" > <img
												src="/sitefiles/images/promoType/OTHER.png" alt="promoType"
												class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="EVENT" > <img
												src="/sitefiles/images/promoType/EVENT.png" alt="promoType"
												class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="POLL" > <img
												src="/sitefiles/images/promoType/POLL.png" alt="promoType"
												class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="PHOTO_CONTEST" > <img
												src="/sitefiles/images/promoType/PHOTO_CONTEST.png"
												alt="promoType" class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="CAMPAIGN_PROMOTION" > <img
												src="/sitefiles/images/promoType/CAMPAIGN_PROMOTION.png"
												alt="promoType" class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="CAMPAIGN_SUBSCRIBE_FOR_NOTIFICATION" >
											<img src="/sitefiles/images/promoType/CAMPAIGN_SUBSCRIBE.png"
												alt="promoType" class="promoType promo-type"> </#if>
											<#if tile.promoType.enumText=="AD_ALERT" > <img
							...
							<table class="table table-bordered businesses-table">
								...
								<tbody>
									...
									<tr>
										...
										<td class="distance-conatiner"><a
											href="${sasl.onClickURL}">${sasl.distanceInMiles} miles</a></td>
										<td class="marker-container"><a href="${sasl.onClickURL}"><span
