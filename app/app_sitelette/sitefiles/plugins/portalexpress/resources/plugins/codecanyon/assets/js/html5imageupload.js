...
window.CodeCanyon=function (window, $, undefined) {
	"use strict";
	...
	$.html5imageupload = function html5imageupload(options, element) {
		...
		this.plugInUrl='resources/plugins/codecanyon/assets/images/';
		//buttons
		this.button				= {}
		this.button.edit		= '<div class="cstbtn btn-edit" title="' + (this.options.editTitle || 'Edit') + '"><img src="'+this.plugInUrl+'btn-edit.png"></div>'
        
		this.button.saving		= '<div class="btn btn-warning saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="glyphicon glyphicon-time"></i></div>';
        
		this.button.zoomin		= '<div class="cstbtn btn-zoom-in" title="' + (this.options.zoominTitle || 'Zoom in') + '"><img src="'+this.plugInUrl+'btn-zoom-in.png"></div>';
        
		this.button.zoomout		= '<div class="cstbtn btn-zoom-out" title="' + (this.options.zoomoutTitle || 'Zoom out') + '"><img src="'+this.plugInUrl+'btn-zoom-out.png"></div>';
        
		this.button.zoomreset	= '<div class="cstbtn btn-zoom-reset" title="' + (this.options.zoomresetTitle || 'Fullsize') + '"><img src="'+this.plugInUrl+'btn-zoom-reset.png"></div>';
...
//		this.button.rotateccw	= '<div class="btn btn-default btn-rotate-ccw" title="' + (this.options.ccwTitle || 'Rotate counter clockwise') + '"><i class="glyphicon glyphicon-share icon-flipped"></i></div>';
		this.button.cancel		= '<div class="cstbtn btn-cancel" title="' + (this.options.cancelTitle || 'Cancel') + '"><img src="'+this.plugInUrl+'btn-cancel.png"></div>';
		this.button.done		= '<div class="cstbtn btn-ok" title="' + (this.options.okTitle || 'Ok') + '"><img src="'+this.plugInUrl+'btn-ok.png"></div>';
		this.button.del			= '<div class="cstbtn btn-del" title="' + (this.options.delTitle || 'Delete') + '"><img src="'+this.plugInUrl+'btn-del.png"></div>';
