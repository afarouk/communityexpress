		...
		<div class="home_body p-0">
			...
			<ul class="home_tabs_list">
				...
				<li id="cmtyx_poll_block" class="poll_block">
					...
					<div class="body">
						<img class="poll_image"
							src="themes/2/placeholder_images/6359862041401967861409225263_coffee.png"></img>
								...
								<div class="prize_block">
									<div class="ui-grid-a prize_container">
										...
										<div class="ui-block-b ">
											<img src="themes/2/placeholder_images/burger.png"></img>
										</div>
									</div>
								</div>
							</li>
				...
				<li id="cmtyx_photo_contest_block" class="photo_contest_block">
					...
					<div class="body">
						<img src="themes/2/placeholder_images/special.png"></img> <span
