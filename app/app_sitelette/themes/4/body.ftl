<body>
	...
	<div id="cmtyx_header" data-role="header" class="header common_header">
		...
		<div class="logo_container"
			...
			<!--  <img src="themes/4/placeholder_images/ZAZA-Grill.png" /> -->
		...
		<div class="home_body p-0">
			...
			<!--
			 <div style="text-align:center; margin: auto auto; background-color:white; height: 120px; width: 355px;">
	          	<a href="https://www.facebook.com/dialog/oauth?client_id=630212017138999&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2Fapptsvc%2Frest%2Fext%2FfacebookLogin&scope=email"> <img style="margin-top: 138px;" src="themes/4/placeholder_images/facebookloginbutton.png" />
	          	</a>
	         </div>
	        -->
			<ul class="home_tabs_list">
				...
				<li id="cmtyx_poll_block" class="poll_block">
					...
					<div class="body">
						<img class="poll_image"
							src="themes/4/placeholder_images/6359862041401967861409225263_coffee.png"></img>
								...
								<div class="prize_block">
									<div class="ui-grid-a prize_container">
										...
										<div class="ui-block-b ">
											<img src="themes/4/placeholder_images/burger.png"></img>
										</div>
									</div>
								</div>
							</li>
				...
				<li id="cmtyx_photo_contest_block" class="photo_contest_block">
					...
					<div class="body">
						<img src="themes/4/placeholder_images/special.png"></img> <span
				          ...
				          <li>
	 						...
	 						<#if videoNeedsPlaceholder>
			                    <div id="externalvideo${media.idMedia}" class="embedded_videos external" idmedia="${media.idMedia}" idVideo="${media.vid}" srcmedia="https://www.youtube.com/embed/${media.vid}?playsinline=1" style="background: #000 url(&quot;${media.thumbnailURL}&quot;)  no-repeat center center;">
			                      <a href="#">
			                        <img src="themes/4/css/images/play.png" alt="Play" srcmedia="https://www.youtube.com/embed/${media.vid}?playsinline=1">
			                      </a>
			                    </div>
		...
		<div class="body">
			...
			<div class="select_picture_container">
				...
				<div class="select_picture_gallery">
					<img src="themes/4/placeholder_images/pexels-photo-59523.png"
						alt=""> <img
						src="themes/4/placeholder_images/6359862041401967861409225263_coffee.png"
						alt=""> <img src="themes/4/placeholder_images/burger.png"
						alt=""> <img src="themes/4/placeholder_images/special.png"
						alt=""> <img
						src="themes/4/placeholder_images/Salad_platter.png" alt="">
				</div>
