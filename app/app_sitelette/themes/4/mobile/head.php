...
<head>
    ...
    <link rel="apple-touch-startup-image" href="themes/4/mobile/splash/Default-portrait@2x~iphone5.png">
    ...
    <style type="text/css">
        body {
            ...
            background-image: url("themes/4/mobile/splash/Default-portrait@2x~iphone5.png");
