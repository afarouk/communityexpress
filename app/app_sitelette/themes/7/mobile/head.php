...
<head>
    ...
    <?php
     if (isset($barFontColors)) {
      ...
      include_once 'themes/7/mobile/css/barFontColors.css';
     }
    ?>
    </style>
    <link href="themes/7/mobile/css/style.css?version=3" rel="stylesheet">

    <script src="build/mobile.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDon847P6x8IUl-pBwSMvvuZd3g2186uhQ"></script>
    <script src="https://connect.facebook.net/en_US/sdk.js"></script>

    <link rel="apple-touch-startup-image" href="themes/7/mobile/splash/Default-1242@3x~iphone6s-portrait_1242x2208.png">
    ...
    <link rel="icon" href="themes/7/favicon.ico?v=1.2">
    ...
    <style type="text/css">
        body {
            ...
            background-image: url("themes/7/mobile/splash/Default-1242@3x~iphone6s-portrait_1242x2208.png");
