...
<head>
    ...
    <link rel="apple-touch-startup-image" href="themes/6/mobile/splash/Default@2x~iphone_640x960.png">
    ...
    <link rel="icon" href="themes/6/favicon.ico?v=1.2">
    ...
    <style type="text/css">
        body {
            ...
            background-image: url("themes/6/mobile/splash/Default@2x~iphone_640x960.png");
