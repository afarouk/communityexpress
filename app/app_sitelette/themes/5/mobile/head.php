...
<head>
    ...
    <link rel="apple-touch-startup-image" href="themes/5/mobile/splash/Default-portrait@2x~iphone5.jpg">
    ...
    <style type="text/css">
        body {
            ...
            background-image: url("themes/5/mobile/splash/Default-portrait@2x~iphone5.jpg");
