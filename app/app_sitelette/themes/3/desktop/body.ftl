    ...
    <div id="cmtyx_desktop_application" class="cmtyx_desktop_application">
                            ...
                            <#list promotions as promotion>
                              <li class="promotions-item" data-uuid="${promotion.uuid}">
                                  <div class="promotion-container">
                                      <img src="themes/3/desktop/images/dog.png" alt="promotion image" class="promotion-image">
                                      <div class="promotion-btns">
                                          <div class="left-block">
                                            <span><img src="themes/3/desktop/images/like-icon.png" alt="like icon">Like</span>
                                          </div>
                                          <div class="right-block">
                                            <span><img src="themes/3/desktop/images/share-icon.png" alt="share icon">Share</span>
                                          </div>
                                      </div>
                                  </div>
                              </li>
                  ...
                  <!-- <div class="grid-item cmtyx_promocodes_block">
                      ...
                      <div class="body">
                          <div class="discount-item-container">
                              <img src="themes/3/desktop/images/burger.png" alt="discount image">
                  ...
                  <!-- events -->
                    <#if (eventsSummary.events)?has_content >
                      <!-- <div class="grid-item grid-item--height3 cmtyx_events_block">
                          ...
                          <div class="body">
                              <img src="themes/3/desktop/images/red-hot-band.png" alt="event image">
                                <table>
                                    <tr>
                                        ...
                                        <td class="add_to_calendar_btn_container first">
                                            <img src="themes/3/desktop/images/280-Appointment_calendar_date_month_planner_reminder_schedule_add_plus-256.png" alt="calendar icon" class="add_to_calendar_btn">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="event_date">
                    ...
                    <!-- <div class="grid-item cmtyx_sale_block">
                        ...
                        <div class="body">
                            <div class="sale-item-container">
                                <img src="themes/3/desktop/images/coffee.png" alt="sale-item" class="sale-item">
                    ...
                    <!-- <div class="grid-item grid-item--height3 cmtyx_poll_block">
                        ...
                        <div class="body">
                              <img src="themes/3/desktop/images/coffee.png" alt="poll image">
                                    ...
                                    <div class="discount_block">
                                         <div class="discount_container">
                                              ...
                                              <div class="prize-picture-container">
                                                <img src="themes/3/desktop//images/discount_burger.png" alt="discount image">
                                              </div>
                                          </div>
                                     </div>
                                </li>
                                <li>
                                    <div class="discount_block">
                                         <div class="discount_container">
                                              ...
                                              <div class="prize-picture-container">
                                                <img src="themes/3/desktop/images/discount_coffee.png" alt="discount image">
                                              </div>
                                          </div>
                                     </div>
                                </li>
                    ...
                    <!-- <div class="grid-item cmtyx_about_us">
                        ...
                        <div class="body">
                            ...
                            <div class="about-address"><img src="themes/3/desktop/images/marker-icon.png" alt="marker icon">1086 North 1st Street, San jose CA 95112</div>
                            <div class="about-phone"><img src="themes/3/desktop/images/phone-icon.png" alt="phone icon">123-456-789</div>
                            <div class='about-business-hours'>Business hours 16.00-02:00</div>
                            <img src="themes/3/desktop/images/map.png" alt="map" class="map-img">
                        </div>
                    </div> -->
                        ...
                        <div class="body">
                                ...
                                <table>
                                    <tr>
                                        <td class="user_avatar">
                                          <img src="themes/3/desktop/images/guy-912229_960_720.png" alt="avatar">
                                        </td>
                            ...
                            <div class="show_more_block">
                                <div class="show_more_avatars_container">
                                    <img src="themes/3/desktop/images/landscape_nrm_1416942794-chris-prat-cover.png" alt="avatar" class="avatar"></img>
                                    <img src="themes/3/desktop/images/guy-912229_960_720-copy.png" alt="avatar" class="avatar"></img>
                                    <img src="themes/3/desktop/images/girl-03.png" alt="avatar" class="avatar"></img>
                                    <img src="themes/3/desktop/images/images.png" alt="avatar" class="avatar"></img>
                                    <img src="themes/3/desktop/images/guy-912229_960_720-copy.png" alt="avatar" class="avatar"></img>
                                </div>
        ...
        <footer>
            <div class="rights-block">
                <img src="themes/3/desktop/images/chalkboards_tiny.png" alt="logo" class="logo">
